...
const char* mqtt_server = "c2f562274065493ba19a32413408826b.s1.eu.hivemq.cloud";
const char* mqtt_username = "AdminRill";
const char* mqtt_password = "Admin#1234";
...
void callback(char* topic, byte* message, unsigned int length) {
  ...
  if (messageValue == 1) {
    ...
    client.publish(mqttPublishTopic, "ON");
  } else if (messageValue == 0) {
    digitalWrite(ledPin, LOW);
    Serial.println("LED is OFF");
    client.publish(mqttPublishTopic, "OFF");
  } else {
